...
const BookingDetail = () => {
  ...
  const bookingStatus = booking.status || "-";
  const isDraft = bookingStatus === "DRAFT";
  const isComplete = bookingStatus === "SUCCESS" || bookingStatus === "COMPLETE";
  ...
  // Static logo URL for now - later from API template
  const logoUrl = "https://via.placeholder.com/200x100/102a54/ffffff?text=LOGO";
    ...
    <div className="booking-page">
      <div className="booking-card" ref={printRef}>
        ...
        {isComplete && (
          <div className="booking-watermark-container">
            {[...Array(20)].map((_, index) => (
              <div key={index} className="booking-watermark logo-watermark">
